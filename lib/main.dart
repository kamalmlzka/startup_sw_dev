...
import 'package:startup_sw_dev/app/utils/notification.dart';
...
import 'package:startup_sw_dev/app/utils/device_info.dart';
...
final List appLanguages = [
  ...
  {'name': 'Bahasa Indonesia', 'locale': const Locale('id', 'ID')},
];
...
void main() async {
  ...
  const LinuxInitializationSettings initializationSettingsLinux =
      LinuxInitializationSettings(defaultActionName: 'TimeMaster');
  ...
  await NotificationShow().requestNotificationPermission();
      ...
      child: DynamicColorBuilder(
        builder: (lightColorScheme, darkColorScheme) {
          ...
          return GetMaterialApp(
            ...
            // home: settings.onboard ? const SplashView() : const OnBording(),
