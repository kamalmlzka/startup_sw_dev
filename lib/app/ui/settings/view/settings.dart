...
import 'package:startup_sw_dev/app/controller/isar_contoller.dart';
import 'package:startup_sw_dev/app/data/db.dart';
import 'package:startup_sw_dev/app/modules/auth/controllers/auth_controller.dart';
import 'package:startup_sw_dev/app/ui/settings/widgets/settings_card.dart';
import 'package:startup_sw_dev/main.dart';
import 'package:startup_sw_dev/theme/theme_controller.dart';
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            SettingCard(
              icon: const Icon(IconsaxPlusLinear.star),
              text: 'premium'.tr,
              onPressed: () {
                showModalBottomSheet(
                  context: context,
                          ...
                          return SingleChildScrollView(
                            child: Column(
                              ...
                              children: [
                                ...
                                SettingCard(
                                  elevation: 4,
                                  icon: const Icon(IconsaxPlusLinear.star_1),
                                  text: 'Basic',
                                  onPressed: () {},
                                ),
                                SettingCard(
            ...
            SettingCard(
              ...
              onPressed: () =>
                  urlLauncher('https://github.com/kamalmlzka/startup_sw_dev'),
            ),
            SettingCard(
