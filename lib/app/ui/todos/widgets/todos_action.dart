...
import 'package:startup_sw_dev/app/data/db.dart';
import 'package:startup_sw_dev/app/controller/todo_controller.dart';
import 'package:startup_sw_dev/app/utils/show_dialog.dart';
import 'package:startup_sw_dev/app/ui/widgets/button.dart';
import 'package:startup_sw_dev/app/ui/widgets/text_form.dart';
  ...
  Widget build(BuildContext context) {
            ...
            fieldViewBuilder: (BuildContext context,
              ...
              return MyTextForm(
                ...
                validator: (value) {
                  ...
                  final categoryFound = todoController.tasks.any((task) =>
    ...
    final todoDateWidget = RawChip(
      ...
      onPressed: () async {
        ...
        plus.DatePickerTheme getDatePickerTheme(BuildContext context) {
          final themeData = Theme.of(context);

          // Apply theme based on brightness
          if (themeData.brightness == Brightness.light) {
            return plus.DatePickerTheme(
              backgroundColor: colorSchemeLight.surface,
              itemStyle: TextStyle(color: darkColor),
            );
          } else {
            return plus.DatePickerTheme(
              backgroundColor: colorSchemeDark.surface,
              itemStyle: TextStyle(color: lightColor),
            );
          }
        }

        await plus.DatePicker.showDateTimePicker(
          context,
          ...
          locale: plus.LocaleType.id,
          theme: getDatePickerTheme(context),
        );
        if (dateTime != null) {
